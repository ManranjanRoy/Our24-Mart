...
public class ProductlistAdaptor extends RecyclerView.Adapter<ProductlistAdaptor.ImageViewHolder> {
...
public ProductlistAdaptor(Context mContext, List<ProductListModel> mUploads, TextView count) {
...
public void onBindViewHolder(final ImageViewHolder holder, final int position) {
        ...
        final ProductListModel uploadCurrent = mUploads.get(position);
            ...
            int stock =Integer.parseInt(uploadCurrent.getStock());
            if (stock ==0){
          ...
          //  holder.txtdesc.setText(uploadCurrent.getDescription());
            ...
            holder.addtocart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    addtocartfun(position,holder.addbuttonlayout,holder.quantitylayout);
                    holder.addbuttonlayout.setVisibility(View.GONE);
                   holder.quantitylayout.setVisibility(View.VISIBLE);
                }
            });
    ...
    private void addtocartfun(int position, LinearLayout addbuttonlayout, LinearLayout quantitylayout) {
...
public class ImageViewHolder extends RecyclerView.ViewHolder {
    ...
    Button addtocart;
    //RelativeLayout ll;
    LinearLayout addbuttonlayout,quantitylayout,addtocartlayout,outofstocklayout;
    ...
    public ImageViewHolder(View itemView, final OnitemClickListner listner) {
        ...
        outofstocklayout=itemView.findViewById(R.id.outofstocklayout);
