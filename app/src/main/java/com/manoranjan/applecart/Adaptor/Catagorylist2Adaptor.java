...
public class Catagorylist2Adaptor extends RecyclerView.Adapter<Catagorylist2Adaptor.ImageViewHolder> {
private Context mContext;
private List<CatagoryModel> mUploads;

public Catagorylist2Adaptor(Context mContext, List<CatagoryModel> mUploads) {
