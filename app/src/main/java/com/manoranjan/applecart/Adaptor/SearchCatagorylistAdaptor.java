...
public class SearchCatagorylistAdaptor extends RecyclerView.Adapter<SearchCatagorylistAdaptor.ImageViewHolder> {
private Context mContext;
private List<CatagoryModel> mUploads;

public SearchCatagorylistAdaptor(Context mContext, List<CatagoryModel> mUploads) {
...
public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_searchcatagory, parent, false);
